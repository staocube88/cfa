...
<php lang="en">
  <head>
    <title>Communion Faith Assembly :: Contact</title>
    <meta charset="utf-8">
        ...
        <div class="row">
            ...
            <form action="#" class="p-5 bg-white">
              ...
              <div class="row form-group">
                <div class="col-md-12">
                  ...
                  <textarea name="message" id="message" cols="30" rows="5" class="form-control" placeholder="Send a message to us "></textarea>
                </div>
              </div>
          ...
          <div class="col-lg-4">
            <div class="p-4 mb-3 bg-white">
              ...
              <p class="mb-4">185,Olabisi Onabanjo Way,Former 7up Deport,Iyana Mortuary, Abeokuta,Ogun-State</p>

              <p class="mb-0 font-weight-bold">Phone</p>
              <p class="mb-4"><a href="#"> (+234) 813-2915-001</a></p>

              <p class="mb-0 font-weight-bold">Email Address</p>
              <p class="mb-0"><a href="#">church@communionfaithassembly.org.ng</a></p>

            </div>
            
            <div class="p-4 mb-3 bg-white">
              <h3 class="h5 text-black mb-3">More Info</h3>
              <p>For prayer and counselling ! Call the number above...<br>
              Stay Blessed !!!</p>
