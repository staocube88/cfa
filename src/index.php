                ...
                <nav class="site-navigation text-right" role="navigation">
                  <div class="container">
                    ...
                    <ul class="site-menu js-clone-nav d-none d-lg-block">
                      ...
                      <!-- <li class="has-children active">
                        <a href="beliefs.php">Church Update</a>
                        <ul class="dropdown arrow-top">
                          <li><a href="beliefs.php">Brothers' Corner</a></li>
                          <li><a href="pastors.php">Sisters' Corner</a></li>
                          <li><a href="beliefs.php">Youths' Corner</a></li>
                          <li><a href="beliefs.php">Childrens' Corner</a></li>
                        </ul>
                      </li> -->
      ...
      <div class="container">
        <div class="d-block d-md-flex border-bottom">
          <div class="text-center p-4 item border-right">
            ...
            <p><a href="about.php">Read More <span class="icon-arrow-right small"></span></a></p>
          </div>
