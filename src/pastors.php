...
<html lang="en">
  <head>
    <title>Communion Faith Assembly :: Ministers</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mx-auto text-center mb-5 section-heading">
            <h2> Meet The Men Of God</h2>
          </div>
        </div>


        <div class="row">
          <div class="col-md-6 col-lg-6 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/go.jpg" alt="" class="img-fluid">
              </a>
            </div>
            <h2 class="heading mb-0 text-center"><a href="#">Rev. Tunde Akin-Akinsanya</a></h2>
          ...
          <div class="col-md-6 col-lg-6 mb-5 mb-lg-0 media-with-text">
           ...
           <h2 class="heading mb-0 text-center"><a href="#">Rev.(Mrs) Yetunde Akin-Akinsanya</a></h2>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/pastors/pastor_great.jpg" alt="" class="img-fluid">
              </a>
            </div>
            <h2 class="heading mb-0 text-center"><a href="#">Pastor Abraham Great</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span> --> 
            <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/pastors/pastor-sam.jpg" alt="" class="img-fluid">
              </a>
            </div>
           <h2 class="heading mb-0 text-center"><a href="#">Pastor Sam Alonge</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span>  -->
            <!-- <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="#">Josh Holmes</a></span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/pastors/pastor-oloyede.jpg" alt="" class="img-fluid">
              </a>
            </div>
            <h2 class="heading mb-0 text-center"><a href="#">Pastor Oloyede Edun</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span> --> 
            <!-- <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="#">Josh Holmes</a></span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/pastors/evang_dairo.jpg" alt="" class="img-fluid">
              </a>
            </div>
            <h2 class="heading mb-0 text-center"><a href="#">Evang. Olatunde Dairo</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span> --> 
            <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/pastors/elder_yeku.jpg" alt="" class="img-fluid">
              </a>
            </div>
           <h2 class="heading mb-0 text-center"><a href="#">Elder Solomon Yeku</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span>  -->
            <!-- <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="#">Josh Holmes</a></span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/pastors/deacon_jayere.jpg" alt="" class="img-fluid">
              </a>
            </div>
            <h2 class="heading mb-0 text-center"><a href="#">Deacon Temidayo Jayere</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span> --> 
            <!-- <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="#">Josh Holmes</a></span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
        ...
        <div class="clearfix" style="margin-top:30px;"></div>
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/pastors/deacon_adeoye.jpg" alt="" class="img-fluid">
              </a>
            </div>
            <h2 class="heading mb-0 text-center"><a href="#">Deacon Joy Adeoye</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span> --> 
            <!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/pastors/deacon_edun.jpg" alt="" class="img-fluid">
              </a>
            </div>
           <h2 class="heading mb-0 text-center"><a href="#">Deaconess Edun</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span>  -->
            <!-- <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="#">Josh Holmes</a></span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0 media-with-text">
            <div class="img-border-sm mb-4">
              <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
                <img src="images/pastors/deaconess_great.jpg" alt="" class="img-fluid">
              </a>
            </div>
            <h2 class="heading mb-0 text-center"><a href="#">Deaconess Great</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span> --> 
            <!-- <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="#">Josh Holmes</a></span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
          <div class="col-md-6 col-lg-3 mb-5 mb-lg-0 media-with-text">
            ...
            <h2 class="heading mb-0 text-center"><a href="#">Deaconess Akinbunmi</a></h2>
            <!-- <span class="mb-3 d-block post-date text-center">General Overseer</a></span> --> 
            <!-- <span class="mb-3 d-block post-date">January 20, 2018 &bullet; By <a href="#">Josh Holmes</a></span>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio dolores culpa qui aliquam placeat nobis veritatis tempora natus rerum obcaecati.</p> -->
          </div>
